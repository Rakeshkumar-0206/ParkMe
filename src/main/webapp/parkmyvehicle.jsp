		...
		<form action='parkmyvehicle.jsp' method='GET'>
			<div class='form-row'>
				<div class='form-group col-md-4'>
					<input type='text' placeholder='560008' class='form-control'
						id='inputPincode' name='inputPincode' required>
				</div>
				<div class='form-group col-md-6'>
					<input type='text' placeholder='Bengaluru' class='form-control'
	...
	<div class='container align-items-center'>
		<div class='row'>
			...
			if(pincode == null)
				...
				try {
						statement = con.prepareStatement("SELECT cityId FROM city WHERE city LIKE '%'?'%' OR pincode = ?");
